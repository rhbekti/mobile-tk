package com.rhbekti.mylocation
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // disesuaikan dengan id yg dibuat pada activity_main
        latTextView = findViewById(R.id.textLatitude)
        lonTextView = findViewById(R.id.textLongtitude)
